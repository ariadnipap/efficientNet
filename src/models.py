...
def get_model(model_name, output_dim, pretrained=True, get_last_dim=False):
    ...
    if model_name == "resnet18":
        ...
        model.classifier[1] = nn.Linear(last_dim, output_dim) if output_dim is not None else nn.Identity()
    elif model_name == "efficientnet_b2":
        weights = torchvision.models.EfficientNet_B2_Weights.IMAGENET1K_V1 if pretrained else None
